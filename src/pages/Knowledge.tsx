...
import { Search, BookOpen, Copy, Folder, FolderOpen, File, Upload, Plus, FolderPlus, ChevronRight, Download, FileText, Image as ImageIcon, Table2, Loader2, Trash2, Eye, X } from 'lucide-react';
